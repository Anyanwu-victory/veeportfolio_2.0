...
export default function Navigation({
  ...
  return (
    <>
      ...
      <nav
        onMouseLeave={leave}
        className="fixed inset-x-0 top-[46vh] z-40 hidden -translate-y-1/2 md:block"
      >
        ...
        <div className="mx-auto flex max-w-450 justify-between px-10 items-center mt-50">
...
// The ghost background should be 1 sec fast than the f=ghost word. the sghost background should open first and the ghost word should appear after 1 sec. The ghost word should disappear first  and the ghost background should close after 1 sec.